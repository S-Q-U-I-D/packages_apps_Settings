...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    void updateBatteryTempPreference() {
        if (batteryTemp) {
            mBatteryTemp.setSubtitle(
                com.android.internal.util.aosp.AospUtils.batteryTemperature(getContext(), false));
            batteryTemp = false;
        } else {
            mBatteryTemp.setSubtitle(
                com.android.internal.util.aosp.AospUtils.batteryTemperature(getContext(), true));
            batteryTemp = true;
        }
    }
