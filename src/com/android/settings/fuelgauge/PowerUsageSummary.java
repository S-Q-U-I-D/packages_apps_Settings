...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.squid.SquidUtils.mccCheck(getContext()) ?
                com.android.internal.util.squid.SquidUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.squid.SquidUtils.batteryTemperature(getContext(), false) + "°C");
    }
